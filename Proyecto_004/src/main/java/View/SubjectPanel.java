		...
		if (input != null && !input.isEmpty()) {
			try {
				...
				if (subject != null) {
					...
					JOptionPane.showMessageDialog(this, panel, "Details of a Subject", JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(this, "No subject was found with the provided ID.", "Error",
