	...
	private void createSchedule() throws NumberFormatException {
		...
		if (result == JOptionPane.OK_OPTION) {
			try {
				...
				JOptionPane.showMessageDialog(this, "Schedule created successfully.", "Success",
						JOptionPane.INFORMATION_MESSAGE);
			} catch (IllegalArgumentException ex) {
				JOptionPane.showMessageDialog(this, "Invalid input. Please enter valid data.", "Error",
		...
		if (input != null && !input.isEmpty()) {
			try {
				...
				if (schedule != null) {
					...
					JOptionPane.showMessageDialog(this, panel, "Details of a Schedule",
							JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(this, "No schedule was found with the provided ID.", "Error",
							JOptionPane.ERROR_MESSAGE);
				}
			...
			try {
				...
				if (scheduleToUpdate != null) {
					...
					if (newStartTimeInput != null && !newStartTimeInput.isEmpty() && newEndTimeInput != null
						...
						JOptionPane.showMessageDialog(this, "The Schedule has been successfully updated.", "Success!",
								JOptionPane.INFORMATION_MESSAGE);
					} else {
					...
					JOptionPane.showMessageDialog(this, "No schedule found with ID: " + scheduleId, "Error",
							JOptionPane.ERROR_MESSAGE);
				}
			} catch (NumberFormatException ex) {
				JOptionPane.showMessageDialog(this, "Schedule ID must be an integer.", "Error",
